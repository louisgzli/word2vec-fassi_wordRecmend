...
def parse_args():
    ...
    parser.add_argument('--file_name', type=str,default="./data/word_embedding.txt", help="word2vec embedding store path")
...
def train(args):
    ...
    id2word_dict = {id:word for id,word in enumerate(idx2word)}
    model.save_embedding(id2word=id2word_dict,file_name=args.file_name,use_cuda=args.cuda)
